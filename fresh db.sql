...
INSERT INTO "auth_permission" VALUES(19,'Can add list',7,'add_list');
INSERT INTO "auth_permission" VALUES(20,'Can change list',7,'change_list');
INSERT INTO "auth_permission" VALUES(21,'Can delete list',7,'delete_list');
...
INSERT INTO "django_content_type" VALUES(7,'list','lists','list');
INSERT INTO "django_content_type" VALUES(8,'item','lists','item');
...
CREATE TABLE "lists_item" (
    "id" integer NOT NULL PRIMARY KEY,
    "text" text NOT NULL,
    "list_id" integer NOT NULL REFERENCES "lists_list" ("id")
);
...
CREATE INDEX "lists_item_c142dac4" ON "lists_item" ("list_id");
COMMIT;
